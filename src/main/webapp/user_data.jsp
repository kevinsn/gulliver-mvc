    ...
    <body>
        ...
        <div class="container my-5">
            <div class="text-center mb-5">
                ...
                <h2 class="my-1">Ola <c:out value="${User.name}"/></h2>
                <p><c:out value="${User.email}"/></p>
                <p>
                    <a href="./create_user" class="btn btn-success btn-sm mr-2">Cadastrar novo usuario</a>
                </p>
            </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nome" name="nome" value="<c:out value="${User.name}"/>"
                                disabled required>
                        </div>
                    </div>
                        ...
                        <div class="form-group disabled">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <div class="input-group-prepend">
                                    <div class="input-group-text "><img src="./assets/img/visibilidade.png"
